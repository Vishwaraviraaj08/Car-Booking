...
Kindly note, taxis are passenger vehicles only. 
  ...
  <div className="wrapper">
    <div className="clash-card barbarian">
      <div className="clash-card__image clash-card__image--barbarian">
        <img className="img" src="https://th.bing.com/th/id/R.e42a772f947fadb287486d2743655538?rik=%2b4qFnwjX58WT1A&riu=http%3a%2f%2fpngimg.com%2fuploads%2ftaxi%2ftaxi_PNG6.png&ehk=cYAxiwtrHxeME3mrxl6i530ELmwR08iomnk9EjG9fhs%3d&risl=&pid=ImgRaw&r=0" alt="barbarian" />
      </div>
      {/* <div class="clash-card__level clash-card__level--barbarian">Level 4</div> */}
      <div className="clash-card__unit-name">Sedan Taxis</div>
  ...
  <div className="wrapper">
    <div className="clash-card archer">
      ...
      <div className="clash-card__unit-name">MUVs Taxis
      </div>
      <div className="clash-card__unit-description">
     6 - 7 persons <br /> <br />
