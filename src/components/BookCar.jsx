  ...
  const fetchApiKey = async () => {
    try {
      const response = await fetch(
        "https://us-central1-calvincare-emailservice.cloudfunctions.net/mapkey"
      );
        ...
        <LoadScript googleMapsApiKey={apiKey} libraries={libraries}>
                ...
                <div className="book-content__box">
                  ...
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    <label style={{ fontSize: "16px", fontWeight: "bold" }}>
                      <i className="fa-solid fa-car"></i> &nbsp;Journey Type
                      <b style={{ color: "red" }}>*</b>
                    </label>
                    <div style={{ display: "flex", gap: "20px" }}>
                      ...
                      />
                      <label style={{ fontSize: "15px" }} htmlFor={"one-way"}>
                        One Way
                      </label>
                    </div>
                    <div style={{ display: "flex", gap: "20px" }}>
                      ...
                      >
                        <div>
                          ...
                          <i
                            ...
                            onClick={pickHandleMapView}
                          ></i>
                          {pickShowMap && (
                            <MapView
                              showMap={pickShowMap}
                              setShowMap={setPickShowMap}
                      ...
                      >
                        <div>
                          ...
                          <i
                            className={"fa fa-location"}
                            style={{ fontSize: "20px", paddingLeft: "6px" }}
                            onClick={dropHandleMapView}
                          ></i>
                          {dropShowMap && (
                            <MapView
                              showMap={dropShowMap}
                              setShowMap={setDropShowMap}
          ...
          >
            ...
            <div className="booking-modal__message">
              ...
              <p>
                Your booking details in the mail to make a Comfortable and safe
                journey.
              </p>
            </div>
            {/* car info */}
            <div className="booking-modal__car-info">
                ...
                <div className="booking-modal__car-info__dates">
                  ...
                  <span style={{ width: "100%" }}>
                    ...
                    <div>
                      ...
                      <p>{changeDateTimeFormat(pickTime)}</p>
                    </div>
                  </span>
                </div>
              ...
              >
                ...
                >
                  ...
                  <h3>
                    <i>
                      NOTE : Above estimation us exclusive of Toll Gate and
                      State Permit Etc
                    </i>
                  </h3>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ fontSize: "1.5rem" }}>
                      {" "}
                      * Price with respect to kms : {price - 300} and
                    </p>
                    <p style={{ fontSize: "1.5rem" }}>
                      {" "}
                      * Driver's Bata : {300}
